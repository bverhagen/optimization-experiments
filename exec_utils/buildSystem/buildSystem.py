...
def buildBuildSystem(target, mode, runMode, compiler, verbose, singleThreaded, prependCommand = None):
    return buildSystem.build(target, mode, runMode, compiler, verbose, singleThreaded, prependCommand)
